...
public class ExtentReportManager {
	...
	public static void startReport()
	{
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/reports/"+dateStamp+"/"+"TruGreen"+timeStamp+".html");
...
*/	
		...
		spark.config().setDocumentTitle("TruGreen_html_Report");
		spark.config().setReportName("TruGreen_html_Report");
